...
## 内存
所有V2都采用了LPDDR4x 4266规格的内存。当时我们对使用3933还是4266有过一定讨论，最后还是决定全部使用LPDDR4x 4266。16G的内存板载无法更换，但是对于特殊需求的用户（比如我）还有32G的SKU可选。据我所知，目前市面上很少有32G LPDDR4x的方案，对于内存有需求的用户来说，32G的SKU就很有竞争力了。这台机器采用的是镁光的颗粒
## SSD
